...
export default {
    ...
    computed: {
        ...
        page: {
            get() {
                return this.$store.state.visittt.page
            },
            set(val) {
                this.$store.commit('visittt/SET_PAGE', val)
            }
        }
    },
    watch: {
    ...
    methods: {
        ...mapActions('visittt', ['getActTT', 'removeVisit']),
        deleted(id) {
            this.$swal({
                title: 'Kamu Yakin?',
        ...
        view(id){
          this.$router.push({ name: 'visittt.show', params: {id: id} })
        },
        edit(id){
          this.$router.push({ name: 'visittt.edit', params: {id: id} })
        },
        create(){
