<template>
    <div class="card card-warning">
      <div class="card-header">
        <h3 class="card-title">Update Visit Data Jaminan</h3>
      </div>
        <div class="card-body">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions('visitjm', ['editActTT', 'updateVisit']),
            submit() {
                this.loading = true
                this.updateVisit(this.$route.params.id).then((response) => {
                  this.loading = false
                  this.alert = true
                  ...
                  setTimeout(() => {
                      this.alert = false
                      this.$router.push({ name: 'visitjm.data' })
                  }, 2000)
                })
            }
        },
